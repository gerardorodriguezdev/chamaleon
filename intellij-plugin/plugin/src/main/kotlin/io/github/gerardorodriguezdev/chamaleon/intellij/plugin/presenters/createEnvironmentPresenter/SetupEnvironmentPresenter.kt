...
internal class SetupEnvironmentPresenter(
    ...
    private fun updateSuccessProcessing(processingResult: ProcessingResult.Success) {
        mutableState.value.copy(
            ...
            isNextButtonEnabled = mutableState.value.environmentNameVerification.isValid(),
    ...
    private fun updateEnvironmentName(newEnvironmentName: String) {
        ...
        mutableState.value.copy(
            ...
            isNextButtonEnabled =
                mutableState.value.environmentsDirectoryVerification.isValid() && environmentNameVerification.isValid(),
        )
    }
